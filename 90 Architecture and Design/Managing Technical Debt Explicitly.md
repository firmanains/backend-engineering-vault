...
**Interest rate technical debt cenderung meningkat, bukan tetap.** Semakin lama debt dibiarkan, semakin banyak kode baru yang dibangun **di atas** fondasi yang mengandung debt itu (dependency baru pada asumsi yang rapuh), membuat biaya pelunasan di masa depan lebih besar dari biaya pelunasan sekarang. Ini properti yang membuat "menunda selamanya" menjadi strategi yang secara matematis semakin buruk seiring waktu, berbeda dari sekadar menunda pembayaran yang bunganya tetap.
