...
3. **Refresh proaktif (early recomputation)** — alih-alih menunggu cache benar-benar kedaluwarsa, sistem me-refresh cache **sebelum** TTL habis (misalnya saat 90% dari durasi TTL sudah berlalu) menggunakan satu request "beruntung" yang kebetulan datang di jendela itu. Request lain tetap menerima data cache lama (yang masih valid) tanpa menunggu, mencegah cache miss terjadi sama sekali untuk key yang sangat populer.
