...
**Langkah berikutnya**: sisa pekerjaan adalah `95 Projects` (3) dan `99 Glossary` (19/20). **← berikutnya: `95 Projects`.**

Seluruh link forward yang ditautkan dari domain `10`–`90`, `92 Tools`, dan `94 Case Studies` yang belum ditulis (proyek, sisa glossary) **sudah terdaftar di [[Vault Manifest]]**, jadi tidak perlu entri baru di tabel backlog di atas; ini murni "belum ditulis", bukan "gap kurikulum".
