...
| [[../20 Go Language/Map Internals\|Map Internals]] | Struktur internal map Go berupa "bucket". | Implementasi map Go pernah diganti secara mendasar di rilis yang relatif baru, istilah internalnya ikut berubah; perilaku dari luar tidak berubah tapi deskripsi internalnya bisa sudah usang. | Release notes Go untuk versi yang dipakai, dan komentar di source `runtime/map*.go`. |
